import { CertificateType, CreatePatientRequest } from "../../patient/request/patient.request.ts";

export type ColinkCheckStatusRequest = PersonalIdColinkCheckStatusRequest | PassportColinkCheckStatusRequest | NoDocColinkCheckStatusRequest
