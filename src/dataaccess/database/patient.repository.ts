...
const PatientRepository = {
  ...
  createPatient: async (patient: CreatePatientRequest) => {
    ...
    const insertAddress = dbUtils.toQuery`INSERT INTO public.address(
      patient_id, address, district, province, zip_code, last_modified_by, last_modified_when, created_by, created_when)
      VALUES (${patientId.nextval}, ${patient.address}, ${patient.district}, ${patient.province}, ${patient.zipCode}, ${"med4all"}, 
      ${currentDateTime}, ${"med4all"}, ${currentDateTime})`;
